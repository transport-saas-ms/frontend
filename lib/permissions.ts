...
export const CAPABILITIES = {
  ...
  UPDATE_OWN_EXPENSES: 'UPDATE_OWN_EXPENSES', // Para drivers - modificar solo sus gastos
...
export const CAPABILITY_GROUPS = {
  ...
  EXPENSES: [CAPABILITIES.MANAGE_EXPENSES, CAPABILITIES.VIEW_OWN_EXPENSES, CAPABILITIES.CREATE_EXPENSE, CAPABILITIES.UPDATE_OWN_EXPENSES, CAPABILITIES.VIEW_REPORTS],
